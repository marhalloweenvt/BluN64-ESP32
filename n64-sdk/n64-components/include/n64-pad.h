...
#include "esp_system.h"
    ...
    // Buttons
    #define BUTTON_A_PIN        GPIO_NUM_15
    #define BUTTON_B_PIN        GPIO_NUM_2

    // DPAD
    #define DPAD_UP_PIN         GPIO_NUM_14
    #define DPAD_DOWN_PIN       GPIO_NUM_26
    #define DPAD_LEFT_PIN       GPIO_NUM_27
    #define DPAD_RIGHT_PIN      GPIO_NUM_12

    // Triggers
    #define TRIGGER_L_PIN       GPIO_NUM_25
    #define TRIGGER_R_PIN       GPIO_NUM_16
    #define TRIGGER_Z_PIN       GPIO_NUM_4
    #define TRIGGER_ZR_PIN      GPIO_NUM_23

    // MISC
    #define BUTTON_START_PIN    GPIO_NUM_13
    #define BUTTON_HOME_PIN     GPIO_NUM_22

    // C-Buttons
    #define C_UP_PIN            GPIO_NUM_5
    #define C_DOWN_PIN          GPIO_NUM_21
    #define C_LEFT_PIN          GPIO_NUM_18
    #define C_RIGHT_PIN         GPIO_NUM_19

    // Joystick
    #define JOYSTICK_X_INT_PIN  GPIO_NUM_33
    #define JOYSTICK_X_Q_PIN    GPIO_NUM_32
    #define JOYSTICK_Y_INT_PIN  GPIO_NUM_34
    #define JOYSTICK_Y_Q_PIN    GPIO_NUM_35

    // LEDs
    #define LED_MODE_PIN        GPIO_NUM_17
#else
    // Buttons
